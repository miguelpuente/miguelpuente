...
<p align="center"> <a href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=miguelpuente" alt="miguelpuente" /></a> </p>
...
class MiguelPuente:
    '''
    Soy un Científico de Datos altamente motivado y curioso, con experiencia en el uso de Python, SQL, técnicas de Ciencia de Datos y desarrollo de software. Mi enfoque analítico y orientado a los detalles me permite abordar problemas complejos y encontrar soluciones efectivas.
    '''
    ...
    def mostrar_habilidades(self):
        habilidades = {
            ...
            'metodologías': ['Limpieza de datos', 'Minería de datos', 'Automatización', 'Desarrollo web']
        }
        return habilidades
    ...
    def mostrar_educación(self):
        educación = {
            'sistemas': 'Técnico Superior en Análisis de Sistemas'
            'administración': 'Técnico Superior en Administración de Empresas'
            'informática': 'Técnico Superior en Informática Administrativa'
    ...
    def mostrar_experiencia(self):
        experiencias = {
            'actual': ['Instructor de Python, SQL y Django en Informatorio Chaco', 'Desarrollador de Software en concesionario oficial TOYOTA']
